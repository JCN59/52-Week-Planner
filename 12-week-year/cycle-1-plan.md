# Cycle 1 Plan — Mon Jun 1 → Sun Aug 23, 2026 (12 weeks)

> Rule: **exactly one goal per business.** Each goal has a **lag measure**
...
- **Weekly lead measures:**
  ...
  - [ ] **Content:** `2` posts · `1` video · `1` ad creative
...
## Cycle scoreboard (fill each Monday from the weekly scorecards)

| Week | Dates | TMES % | CNC % | SGS % | Avg % | Notes |
|------|-------|--------|-------|-------|-------|-------|
| 1 | Jun 1–7 | | | | | |
| 2 | Jun 8–14 | | | | | |
| 3 | Jun 15–21 | | | | | |
...
**Target: 85%+ average execution every week.** Two weeks under 85% for any
one business = intervene there now.
